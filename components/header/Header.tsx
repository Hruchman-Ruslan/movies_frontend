...
const menuData = [
	{
		title: 'Home',
		href: '/',
		icon: <HomeIcon className='w-5 h-5 fill-current' />,
	},
	{
		title: 'Community',
		href: '/community',
		icon: <CommunityIcon className='w-5 h-5 fill-current' />,
	},
	{
		title: 'Discover',
		href: '/discover',
		icon: <DiscoverIcon className='w-5 h-5 fill-current' />,
	},
	{
		title: 'Awards',
		href: '/awards',
		icon: <AwardsIcon className='w-5 h-5 fill-current' />,
	},
	{
		title: 'Celebs',
		href: '/celebs',
		icon: <CelebsIcon className='w-5 h-5 fill-current' />,
	},
]
